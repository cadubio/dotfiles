...
* [Classes](#classes)
   ...
   * [Modificadores de acesso](#modificadores-de-acesso)
      * [<em>Puclic</em>](#puclic)
      * [<em>Private</em>](#private)
         * [Métodos de acesso a atributos privados](#métodos-de-acesso-a-atributos-privados)
* [Construtores](#construtores)
   * [Construtor padrão](#construtor-padrão)
   * [Construtor nomeado](#construtor-nomeado)
   * [Construtor <em>factory</em>](#construtor-factory)
   * [Referências](#referências)
   * [Inicializadores​](#inicializadores)
   * [<em>Null Safety</em>](#null-safety)
   * [Herança](#herança)
   * [Covariant](#covariant)
* [Associação (Composição e Agregação)](#associação-composição-e-agregação)
* [Polimorfismo](#polimorfismo)
* [Interfaces](#interfaces)
* [Auto Promoção de Tipos](#auto-promoção-de-tipos)
* [Mixins](#mixins)
...
* [Ordenação default (Comparable)](#ordenação-default-comparable)
* [Asserts](#asserts)
* [Modificador Const (Construtor)](#modificador-const-construtor)
* [Extensions](#extensions)
* [Metadatas (Annotations)](#metadatas-annotations)
* [Getters e Setters](#getters-e-setters)
* [Constructors Tear-off](#constructors-tear-off)
...
Na realidade o `dart` na implementação de uma classe **abstrata** não direfencia os métodos de classe que devem ser implementado dos que já são implementado na classe. Por isso **a boa pratica** diz para se utilizar métodos não implementados quando definindo um **interface**, como na figura anterior.
...
![](../images/autopromocao-tipos.png)

![](../images/autopromocao-var-nivel-superior.png)
![](../images/autopromocao-var-nivel-superior2.png)

Para variáveis de nível superior e atributos de classe deve-se obrigatoriamente fazer um *cast*.

![](../images/autopromocao-var-nivel-superior2-cast.png)


# Mixins

É a forma de fazer heranças multiplas no `dart`.

# Cascade Notation

É a forma de atribuir valores aos atributos de uma classe assim que ela é instanciada, utilizando os `..` (dois pontos).

![](../images/cascade-notation.png)

![](../images/cascade-notation2.png)
