...
O `dart` inicializa os atributos da classe antes de se inicializar os construtores, dai não ser possível se definir um atributo privado como `final`, como no exemplo:

![](../images/atributo_nao_permitido_contrututor.jpg)
## *Null Safety*​