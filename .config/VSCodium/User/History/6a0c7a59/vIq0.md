...
C​uidado com a palavra reservada `late` pois ela sobrescreve todas as regras como `final`, pois ele faz uma inicialização tardia, a estrutura do *null safaty* deixa de existir, como no uso do `!`