...
// PowerMenu.tsx
var { TOP, BOTTOM, LEFT, RIGHT } = Astal7.WindowAnchor;
var { IGNORE } = Astal7.Exclusivity;
var { EXCLUSIVE } = Astal7.Keymode;
var { CENTER } = Gtk4.Align;
var hypr = Hyprland.get_default();
app_default.start({
    ...
    /* @__PURE__ */ jsx(
      "window",
      {
        ...
        children: /* @__PURE__ */ jsxs("box", { halign: CENTER, valign: CENTER, vertical: true, children: [
          /* @__PURE__ */ jsxs("box", { homogeneous: true, children: [
            /* @__PURE__ */ jsx("button", { onClicked: powerOff, children: /* @__PURE__ */ jsx("icon", { icon: "system-shutdown-symbolic" }) }),
            /* @__PURE__ */ jsx("button", { onClicked: reboot, children: /* @__PURE__ */ jsx("icon", { icon: "system-reboot-symbolic" }) }),
            /* @__PURE__ */ jsx("button", { onClicked: logOut, children: /* @__PURE__ */ jsx("icon", { icon: "system-log-out-symbolic" }) }),
            /* @__PURE__ */ jsx("button", { onClicked: esc, children: /* @__PURE__ */ jsx("icon", { icon: "window-close-symbolic" }) })
          ] }),
          /* @__PURE__ */ jsxs("box", { homogeneous: true, children: [
            /* @__PURE__ */ jsx("label", { label: "[ desligar ]" }),
            /* @__PURE__ */ jsx("label", { label: "[ reiniciar ]" }),
            /* @__PURE__ */ jsx("label", { label: "[ logout ]" }),
            /* @__PURE__ */ jsx("label", { label: "[ fechar ]" })
          ] })
        ] })
      }
    );
