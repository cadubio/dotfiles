...
Quando um atributo está no corpo do construtor a classe já foi inicializada, como no caso dos parametros `id` e `preco` do construtor `Produto`, no exemplo acima
